...
\addbibresource{Thesis/0007_Literature.bib}
...
\usepackage[labelfont=bf, font=footnotesize, labelsep=space, format=plain, list=true, labelformat = parens, aboveskip=0pt, belowskip=0pt, justification=centering]{subcaption}
