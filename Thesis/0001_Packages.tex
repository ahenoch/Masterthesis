...
\usepackage[maxbibnames=99,maxcitenames=2,sorting=nty,uniquelist=false,backend=biber,terseinits=true,bibstyle=numeric,giveninits=true,uniquename=init,citestyle=numeric,sortcites=true]{biblatex}
\urlstyle{same}
...
\usepackage[acronyms, automake=false, counter=chapter, nopostdot, nonumberlist]{glossaries}
\makenoidxglossaries
