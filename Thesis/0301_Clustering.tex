...
\begin{table}[!hbt]
    \centering
    \caption[Kneedle based Clustering (\Acrshort{PCA})]{\textbf{Kneedle based Clustering (\Acrshort{PCA}).} The clustering using the combination of \gls{PCA} and the Kneedle Algorithm (PK), results in the given table. Listed is every used segment with the number of raw clusters and the final cluster number after hybrid clustering with the given value of $\varepsilon$. The number of raw clusters is based on the normalization of the cluster range as used in the Kneedle Algorithm. Mixed cluster numbers of H and N denotes the number of inconclusive clusters when comparing by the respective subtypes. The variance of the \gls{PCA} is calculated by the sum of the 30 components explained variance.}
...
\begin{table}[!hbt]
    \centering
    \caption[Kneedle based Clustering (\Acrshort{UMAP})]{\textbf{Kneedle based Clustering (\Acrshort{UMAP}).} The clustering using the combination of \gls{PCA}, \gls{UMAP} and the Kneedle Algorithm (UK), results in the given table. Listed is every used segment with the number of raw clusters and the final cluster number after hybrid clustering with the given value of $\varepsilon$. The number of raw clusters is based on the normalization of the cluster range as used in the Kneedle Algorithm. Mixed cluster numbers of H and N denotes the number of inconclusive clusters when comparing by the respective subtypes. The variance of the \gls{PCA} is calculated by the sum of the 100 components explained variance.}
...
\begin{table}[!hbt]
    \centering
    \caption[\Acrshort{DBCV} based Clustering (\Acrshort{PCA})]{\textbf{\Acrshort{DBCV} based Clustering (\Acrshort{PCA}).} The clustering using the combination of \gls{PCA} and the \gls{DBCV} exploration (PD), results in the given table. Listed is every used segment with the number of raw clusters and the final cluster number after hybrid clustering with the given value of $\varepsilon$. The number of raw clusters is based on directly on the $\varepsilon$ value. Mixed cluster numbers of H and N denotes the number of inconclusive clusters when comparing by the respective subtypes. The variance of the \gls{PCA} is calculated by the sum of the 30 components explained variance.}
...
\begin{table}[!hbt]
    \centering
    \caption[\Acrshort{DBCV} based Clustering (\Acrshort{UMAP})]{\textbf{\Acrshort{DBCV} based Clustering (\Acrshort{UMAP}).} The clustering using the combination of \gls{PCA}, \gls{UMAP} and the \gls{DBCV} exploration (UD), results in the given table. Listed is every used segment with the number of raw clusters and the final cluster number after hybrid clustering with the given value of $\varepsilon$. The number of raw clusters is based on directly on the $\varepsilon$ value. Mixed cluster numbers of H and N denotes the number of inconclusive clusters when comparing by the respective subtypes. The variance of the \gls{PCA} is calculated by the sum of the 100 components explained variance.}
...
\begin{figure}[!hbt]
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}[x={(image.south east)},y={(image.north west)}]
            ...
            \node at (0.16,0.18) [arrowstyle=1.5cm, arrowfillR, anchor=east, rotate=45] {\textbf{\textsf{A}}};
            \node at (0.5,0.08) [arrowstyle=1.5cm, arrowfillR, anchor=east, rotate=45] {\textbf{\textsf{B}}};
            \node at (0.89,0.62) [arrowstyle=1.5cm, arrowfillR, anchor=east, rotate=180] {\rotatebox{180}{\textbf{\textsf{C}}}};
            \node at (0.7,0.9) [arrowstyle=1.5cm, arrowfillR, anchor=east, rotate=180] {\rotatebox{180}{\textbf{\textsf{D}}}};
        \end{scope}
    \end{tikzpicture}
