...
\begin{figure}[!hbt]
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}[x={(image.south east)},y={(image.north west)}]
            ...
            \node at (0.16,0.18) [arrowstyle=1.5cm, anchor=east, rotate=45] {\rotatebox{315}{\textbf{\textsf{A}}}};
            \node at (0.5,0.08) [arrowstyle=1.5cm, anchor=east, rotate=45] {\rotatebox{315}{\textbf{\textsf{B}}}};
            \node at (0.89,0.62) [arrowstyle=1.5cm, anchor=east, rotate=180] {\rotatebox{180}{\textbf{\textsf{C}}}};
