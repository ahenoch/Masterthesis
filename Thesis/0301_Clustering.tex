...
\begin{figure}
    \begin{adjustbox}{minipage=\dimexpr\textwidth-2\fboxsep-2\fboxrule,fbox}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            ...
            \label{subfig:PCA_Cluster_Knee_Elbow_4}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.475\textwidth}
...
\begin{figure}
    \begin{adjustbox}{minipage=\dimexpr\textwidth-2\fboxsep-2\fboxrule,fbox}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            ...
            \label{subfig:PCA_Cluster_DBCV_Elbow_4}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.475\textwidth}
            \includegraphics[width=\textwidth]{PCA/Cluster_Distribution_Segment_4_alternative.pdf}
            \caption[Cluster Distribution]{\textbf{Cluster Distribution}}
            \label{subfig:PCA_Cluster_DBCV_Distribution_4}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.475\textwidth}
...
\begin{figure}
    \begin{adjustbox}{minipage=\dimexpr\textwidth-2\fboxsep-2\fboxrule,fbox}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            ...
            \caption[Kneedle Knee]{\textbf{Kneedle Knee}}
            \label{subfig:UMAP_Cluster_Knee_Elbow_4}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.475\textwidth}
            \includegraphics[width=\textwidth]{UMAP/Cluster_Distribution_Segment_4.pdf}
            \caption[Cluster Distribution]{\textbf{Cluster Distribution}}
            \label{subfig:UMAP_Cluster_Kne_Distributione_4}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.475\textwidth}
...
\begin{figure}
    \begin{adjustbox}{minipage=\dimexpr\textwidth-2\fboxsep-2\fboxrule,fbox}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            ...
            \caption[\Acrshort{DBCV} Knee]{\textbf{\Acrshort{DBCV} Knee}}
            \label{subfig:UMAP_Cluster_DBCV_Elbow_4}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.475\textwidth}
...
\begin{table}[!hbt]
    \caption[Knee based Clustering with \Acrshort{PCA}]{\textbf{Knee based Clustering with \Acrshort{PCA}.}.}
...
\begin{table}[!hbt]
    \caption[\Acrshort{DBCV} based Clustering with \Acrshort{PCA}]{\textbf{\Acrshort{DBCV} based Clustering with \Acrshort{PCA}.}.}
...
\begin{table}[!hbt]
    \caption[Knee based Clustering with \Acrshort{UMAP}]{\textbf{Knee based Clustering with \Acrshort{UMAP}.}.}
...
\begin{table}[!hbt]
    \caption[\Acrshort{DBCV} based Clustering with \Acrshort{UMAP}]{\textbf{\Acrshort{DBCV} based Clustering with \Acrshort{UMAP}.}.}
