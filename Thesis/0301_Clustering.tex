...
\begin{figure}[!hbt]
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}[x={(image.south east)},y={(image.north west)}]
            ...
            \node at (0.5,0.09) [arrowstyle=1.5cm, anchor=east, rotate=135] {\rotatebox{225}{\textbf{\textsf{A}}}};
            \node at (0.9,0.62) [arrowstyle=1.5cm, anchor=east, rotate=225] {\rotatebox{135}{\textbf{\textsf{B}}}};
            \node at (0.7,0.9) [arrowstyle=1.5cm, anchor=east, rotate=180] {\rotatebox{180}{\textbf{\textsf{C}}}};
        \end{scope}
    \end{tikzpicture}
