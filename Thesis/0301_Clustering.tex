...
\begin{table}[!hbt]
    \centering
    \caption[Kneedle based Clustering (\texttt{PCA})]{\textbf{Kneedle based Clustering (\texttt{PCA}).} The clustering using the combination of \texttt{PCA} and the Kneedle Algorithm (PK), results in the given table. Listed is every used segment with the number of raw clusters and the final cluster number after hybrid clustering with the given value of $\varepsilon$. The number of raw clusters is based on the normalization of the cluster range as used in the Kneedle Algorithm. Mixed cluster numbers of H and N denotes the number of inconclusive clusters when comparing by the respective subtypes. The variance of the \texttt{PCA} is calculated by the sum of the 30 components explained variance.}
...
\begin{table}[!hbt]
    \centering
    \caption[Kneedle based Clustering (\texttt{UMAP})]{\textbf{Kneedle based Clustering (\texttt{UMAP}).} The clustering using the combination of \texttt{PCA}, \texttt{UMAP} and the Kneedle Algorithm (UK), results in the given table. Listed is every used segment with the number of raw clusters and the final cluster number after hybrid clustering with the given value of $\varepsilon$. The number of raw clusters is based on the normalization of the cluster range as used in the Kneedle Algorithm. Mixed cluster numbers of H and N denotes the number of inconclusive clusters when comparing by the respective subtypes. The variance of the \texttt{PCA} is calculated by the sum of the 100 components explained variance.}
...
\begin{table}[!hbt]
    \centering
    \caption[\Acrshort{DBCV} based Clustering (\texttt{PCA})]{\textbf{\Acrshort{DBCV} based Clustering (\texttt{PCA}).} The clustering using the combination of \texttt{PCA} and the \gls{DBCV} exploration (PD), results in the given table. Listed is every used segment with the number of raw clusters and the final cluster number after hybrid clustering with the given value of $\varepsilon$. The number of raw clusters is based on directly on the $\varepsilon$ value. Mixed cluster numbers of H and N denotes the number of inconclusive clusters when comparing by the respective subtypes. The variance of the \texttt{PCA} is calculated by the sum of the 30 components explained variance.}
...
\begin{table}[!hbt]
    \centering
    \caption[\Acrshort{DBCV} based Clustering (\texttt{UMAP})]{\textbf{\Acrshort{DBCV} based Clustering (\texttt{UMAP}).} The clustering using the combination of \texttt{PCA}, \texttt{UMAP} and the \gls{DBCV} exploration (UD), results in the given table. Listed is every used segment with the number of raw clusters and the final cluster number after hybrid clustering with the given value of $\varepsilon$. The number of raw clusters is based on directly on the $\varepsilon$ value. Mixed cluster numbers of H and N denotes the number of inconclusive clusters when comparing by the respective subtypes. The variance of the \texttt{PCA} is calculated by the sum of the 100 components explained variance.}
