...
All the supplementary material can be found on the attached USB-Stick and with exception of the FASTA file in the GitHub repository\footnote{\url{https://github.com/ahenoch/Masterthesis.git}}. The FASTA can be found FSU-Cloud\footnote{\url{https://cloud.uni-jena.de/s/Pd3rcsDiKGsiBGD}}.
