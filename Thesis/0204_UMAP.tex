...
\begin{empheq}{alignat = -1}
    &\mathbf{\hat{X}}_{(100)} = \text{PCA}(\mathbf{\hat{X}}, 100)\label{eq:PCA_100}
\end{empheq}

\begin{empheq}{alignat = -1}
    &\mathbf{Y} &&= \text{UMAP}(\mathbf{\hat{X}}_{(100)}, \text{n\_neighbors}, \text{n\_components}, \text{min\_dist}, \text{n\_epochs})\label{eq:UMAP_d}\\
    &&&= \text{UMAP}(\mathbf{\hat{X}}_{(100)}, 100, 30, 0.0, 200)\label{eq:UMAP_100}
\end{empheq}
