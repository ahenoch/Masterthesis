...
\begin{figure}[!hbt]
    ...
    \caption[Tree Building Pipeline]{\textbf{Tree Building Pipeline.} Following the clustering pipeline (\autoref{fig:Clustering_Pipeline}) the cluster-tree for visualization is build by ETE3 with the help of hierarchy function from the \textbf{scipy} package \autocite{huerta-cepas_ete_2016, scipy_10_contributors_scipy_2020}}
