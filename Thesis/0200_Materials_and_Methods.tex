...
The raw pipeline clusters \gls{IAV} genomes and saves the results as CSV files and colored clustertrees using the ETE 3 \autocite{huerta-cepas_ete_2016}. It is designed to function as a clustering tool, without the need of a running Jupyter Lab server and with easier modification and faster execution in mind (\autoref{fig:Vectorization_Pipeline} and \autoref{fig:Clustering_Pipeline}).
