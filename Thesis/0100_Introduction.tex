...
\begin{figure}[!hbt]
    ...
    \caption[\textit{Influenza A Virus} life-cycle]{\textbf{\textit{Influenza A Virus} life-cycle.} The \gls{IAV} virion attaches itself to the host cell membrane using the cells receptors (\textsf{\textbf{i}}). By endocytosis (\textsf{\textbf{A}}), the virion infiltrates the host cell coating itself in a clathrin bound layer of the hosts cell. After assimilation into the cell, the clathrin coat and the virions lipid layer (\textsf{\textbf{e}}) dissolved 
    }
    \label{fig:Cycle}
\end{figure}
