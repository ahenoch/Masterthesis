...
\begin{figure}[!hbt]
    ...
    \caption[\textit{Influenza A Virus} life-cycle]{\textbf{\textit{Influenza A Virus} life-cycle.} The \gls{IAV} virion attaches itself to the host cell membrane using the cells receptors. By endocytosis, the virion infiltrates the host cell coating itself in a clathrin bound layer of the hosts cell, denoted by the yellow color of the layer (\textsf{\textbf{A}}). After assimilation into the cell, the both lipid layers}
    \label{fig:Cycle}
\end{figure}
